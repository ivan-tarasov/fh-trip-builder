    ...
    <div class="container">
      <div class="container py-4 py-md-5 px-4 px-md-3">
        <div class="row">
          <!-- Info cell -->
          <div class="col-lg-4">
            <a href="/" class="d-flex align-items-center mb-2 mb-lg-0 text-white text-decoration-none me-5 pb-3">
              <i class="fas fa-2x fa-plane-departure pe-3"></i>
              <strong class="lead">Trip Builder</strong>
            </a>
            <ul class="list-unstyled small">
              <li class="mb-2">
                Software made by <a href="https://tarasov.ca/" target="_blank" class="link-light">Ivan Tarasov</a> as <a href="https://www.flighthub.com/" target="_blank" class="link-light">FlightHub</a>
                PHP Coding <a href="Trip_Builder_1.pdf" target="_blank" class="link-light">Assignment</a>.
                Code licensed <a href="https://bitbucket.org/karapuzoff/trip-builder/src/master/LICENSE.txt" target="_blank" class="link-light" rel="license noopener">MIT</a>, docs are available <a href="https://bitbucket.org/karapuzoff/trip-builder/src/master/README.md" target="_blank" class="link-light">here</a>.
                <i class="far fa-lg fa-copyright pe-1"></i>2023
              </li>
              <li class="mb-2">Generated in <code>%EXECUTION_TIMER% seconds</code>, <!--DB requests: %DATABASE_REQUESTS%, API calls: %API_CALLS_COUNT%, -->flights in DB: <code>%FLIGHTS_COUNT%</code></li>
