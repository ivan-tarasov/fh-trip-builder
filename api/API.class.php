...
class API
{
  ...
  private $_token = 'SomeAPItoken_$ecretWORD---orHASH';
  ...
  public function SQLSearchWhere($tablePrefix = null, $returnFlight = false, $type_from = '', $type_to = '')
  {
...
class statusCode extends Exception
{
  public function errorCode()
  {
    ...
    $errorMsg = json_encode($errorMsg, JSON_PRETTY_PRINT);
