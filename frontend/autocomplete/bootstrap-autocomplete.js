...
(function (global, factory) {
  ...
  var Autocomplete = /*#__PURE__*/function () {
    ...
    _proto._makeDropdown = function _makeDropdown() {
      ...
      var tmpl = '<ul class="search dropdown-menu" data-bs-popper="relative"></ul>';
    ...
    _proto._renderItem = function _renderItem(items) {
      ...
      items.forEach(function (i) {
        ...
        item.html(i).appendTo(_this6._dropdown);
    ...
    _proto._selectItem = function _selectItem(item) {
      var input_value = item.innerText.split("|");

      // var hidden_value = input_value[0]+'0'+input_value[1];
      var hidden_value = input_value[0];
      
      // console.log(hidden_value);
      //console.log(input_value);
      
      this._element.value = `${input_value[1]}, ${input_value[2]}`;
      
      if (0 != input_value[3])
        this._element.value += `, ${input_value[3]}`
      
        $("#"+this._element.id+"_value").val(hidden_value);
