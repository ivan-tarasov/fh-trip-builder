(function ($) {
    ...
    | second is long enough that a sentence is one request and short enough that
    | nobody waits for it.
    |
    */
    (function () {
        ...
        var render = function () {
            // Abort the one still running: the answer to two keystrokes ago is
            // not worth waiting for and could arrive after the newer one.
