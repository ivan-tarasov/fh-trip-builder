...
| the command run anywhere. Both `alerts:check` (#385) and `cities:images`
...
| `cities:images` uses. Sunday 04:15, fifteen minutes after
| `cities:images`'s own Sunday 04:00 slot -- the smaller of the two sets
