...
return [
    ...
    */
    'main-menu' => [
        ...
        // Travel writing, as against the help pages about booking here. Shipped
        // disabled while the section was machinery with nothing behind it; on
        // since there are posts to read.
        '/airside/' => [
            'text' => 'Airside',
